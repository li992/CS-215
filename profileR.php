...
if(isset($_GET['email']))
	{
		...
		<div class="Profileframework">
			<article class="profileArticle" id="Body">
				...
				$q2="SELECT * FROM POST where Post_User = '$userID' ORDER BY DateAndTime DESC";
				...
				if(mysqli_num_rows($result)>0){
					...
					echo "<p>Ooops, this user does not have even one post.</p>";
				}
								
				echo "<p>Past Reposts are showing Below:</p><br/>";
				...
				if(mysqli_num_rows($result2)>0){
					...
					echo "<p>Ooops, this user does not have any repost.</p>";
				}
				?>
			</article>
